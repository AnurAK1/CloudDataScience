...
external_stylesheets = [
    "https://github.com/plotly/dash-app-stylesheets/blob/1564e52057ea20b6c23a4047d3d9261fc793f3af/dash-analytics-report.css"
]
...
fig1 = px.scatter(df, x="x", y=["SF", "Montreal"], size="Montreal")
test = "2020-12-01"
max_rows = len(df)
        ...
        html.Div(
            children=[
                ...
                html.Div(
                    ...
                    style={"textAlign": "Left", "color": colors["text"], "padding": 16},
                ),
                html.Div(
                    children=[
                ...
                html.Div(
                    children=[
                        ...
                        dcc.Dropdown(
                            id="country",
                            options=[{"label": i, "value": i} for i in ahsh1],
                            multi=True,
                            style={
                        ...
                        dcc.Dropdown(
                            id="montreal",
                            options=[{"label": i, "value": i} for i in qqwe],
                            multi=True,
                            style={
                                "backgroundColor": colors["background"],
                                "textAlign": "center",
                        ...
                        dcc.Graph(id="example-scatter1", figure=fig1),
                        dcc.Graph(id="example-scatter2", figure=fig1),
                        dcc.Graph(id="example-scatter3", figure=fig1),
                    ],
                    style={"columnCount": 3},
                ),
            ]
